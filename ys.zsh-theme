...
#
# Mar magenta3 Yad Smood

# VCS
YS_VCS_PROMPT_PREFIX1=" %{$reset_color%}on%{$fg[blue]%} "
YS_VCS_PROMPT_PREFIX2=":%{$fg[cyan]%}"
YS_VCS_PROMPT_SUFFIX="%{$reset_color%}"
YS_VCS_PROMPT_DIRTY=" %{$FG[163]%}x"
YS_VCS_PROMPT_CLEAN=" %{$FG[163]%}o"
...
YS_THEME_VIRTUALENV_PROMPT_PREFIX=" %{$FG[163]%}"
...
local exit_code="%(?,,C:%{$FG[163]%}%?%{$reset_color%})"
...
${venv_info}\
 \
[%t] $exit_code
%{$terminfo[bold]$FG[163]%}$ %{$reset_color%}"
